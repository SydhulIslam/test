    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="row">
                    <div class="col-lg-8">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Users /</span> {{ $title }}
                        </h4>
                    </div>
                                        ...
                                        <td>
                                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                    ...
                                                    <img src=" /storage/images/{{ $user->user_photo }} " alt="Avatar"
                                        ...
                                        <td>
                                            <div class="d-grid gap-2 col-6 mx-auto">
                                                ...
                                                <form method="post" action="{{ route('user.destroy', $user->id) }}">
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="modal fade" id="smallModal{{ $user->id }}"
                                                    ...
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                        data-bs-target="#smallModal{{ $user->id }}"> Remove </button>
                                                </form>
                                            </div>
