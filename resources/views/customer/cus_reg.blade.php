        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Register as a Customer 🚀</h4>
              ...
              @endif
                ...
                <form id="formAuthentication" class="mb-3" action="{{route('customer.registion_post')}}" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            ...
                            <div class="button-wrapper">
                                <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                    ...
                                    <input type="file" name="photo" id="upload" class="account-file-input" hidden="" accept="">
                                </label>
                            </div>
                        </div>
                    </div>
